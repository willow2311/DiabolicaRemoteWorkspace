...
public class Modelikuj<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "ikuj"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hexadecagon = partdefinition.addOrReplaceChild("hexadecagon", CubeListBuilder.create()
				.texOffs(140, 1).addBox(-17.9456F, -7.63F, -42.0F, 19.8912F, 0.1F, 100.0F, new CubeDeformation(0.0F))
				.texOffs(140, 224).addBox(-58.0F, -7.68F, -1.9456F, 100.0F, 0.1F, 19.8912F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon_r1 = hexadecagon.addOrReplaceChild("hexadecagon_r1", CubeListBuilder.create()
				.texOffs(140, 203).addBox(-50.0F, 0.31F, -9.9456F, 100.0F, 0.1F, 19.8912F, new CubeDeformation(0.0F))
				.texOffs(0, 101).addBox(-9.9456F, 0.345F, -50.0F, 19.8912F, 0.1F, 100.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition hexadecagon_r2 = hexadecagon.addOrReplaceChild("hexadecagon_r2", CubeListBuilder.create()
				.texOffs(140, 245).addBox(-50.0F, 0.315F, -9.9456F, 100.0F, 0.1F, 19.8912F, new CubeDeformation(0.0F))
				.texOffs(140, 102).addBox(-9.9456F, 0.38F, -50.0F, 19.8912F, 0.1F, 100.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.0F, 0.3927F, 0.0F));

		PartDefinition hexadecagon_r3 = hexadecagon.addOrReplaceChild("hexadecagon_r3",
				CubeListBuilder.create().texOffs(0, 0).addBox(-9.9456F, 0.344F, -50.0F, 19.8912F, 0.1F, 100.0F,
		...
		PartDefinition hexadecagon_r4 = hexadecagon.addOrReplaceChild("hexadecagon_r4",
				CubeListBuilder.create().texOffs(0, 202).addBox(-9.9456F, 0.39F, -50.0F, 19.8912F, 0.1F, 100.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, 0.0F, 0.7854F, 0.0F));
