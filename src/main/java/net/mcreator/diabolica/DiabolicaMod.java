 ...
 *
 */
package net.mcreator.diabolica;
...
import net.mcreator.diabolica.init.DiabolicaModTabs;
import net.mcreator.diabolica.init.DiabolicaModSounds;
...
@Mod("diabolica")
public class DiabolicaMod {
	public static final Logger LOGGER = LogManager.getLogger(DiabolicaMod.class);
	public static final String MODID = "diabolica";

	public DiabolicaMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		DiabolicaModSounds.REGISTRY.register(bus);
		DiabolicaModBlocks.REGISTRY.register(bus);
		DiabolicaModBlockEntities.REGISTRY.register(bus);
		DiabolicaModItems.REGISTRY.register(bus);
