	...
	public static void execute(Entity entity) {
		...
		if (new Object() {
			public int getAmount(int sltid) {
				...
				&& (entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(2)).getItem() : ItemStack.EMPTY).getItem() == DiabolicaModItems.SCROLL.get()) {
			if (entity instanceof Player _player && _player.containerMenu instanceof Supplier _current && _current.get() instanceof Map _slots) {
				ItemStack _setstack = new ItemStack(DiabolicaModItems.SPELLOF_RESURRECTION.get());
